  ...
  <div style="background:#f8fafc;border-radius:8px;padding:0.875rem 1rem;">
    ...
    <div style="display:flex;gap:0.5rem;flex-wrap:wrap;">
      <div style="background:white;border:1px solid #e5e7eb;border-radius:6px;
                  padding:0.35rem 0.75rem;font-size:0.75rem;color:#374151;">40% — Response Quality</div>
      <div style="background:white;border:1px solid #e5e7eb;border-radius:6px;
                  padding:0.35rem 0.75rem;font-size:0.75rem;color:#374151;">40% — Consistency (cross-variant)</div>
      <div style="background:white;border:1px solid #e5e7eb;border-radius:6px;
                  padding:0.35rem 0.75rem;font-size:0.75rem;color:#374151;">20% — Calibration</div>
    </div>
  </div>
  <p style="font-size:0.78rem;color:#9ca3af;margin:0.75rem 0 0 0;">
    All sub-scores are on a 0–1 scale. Trust Score &#8805; 0.8 = green, &#8805; 0.6 = amber, &lt; 0.6 = red.
    For agent evaluations: <code style="font-size:0.75rem;">0.35 &times; semantic_avg + 0.35 &times; hallucination_score + 0.30 &times; tool_accuracy</code>.
  </p>
</div>
""", unsafe_allow_html=True)
...
<div style="background:white;border:1px solid #e5e7eb;border-radius:10px;
  ...
  <ul style="color:#6b7280;font-size:0.82rem;line-height:1.7;margin:0;padding-left:1.2rem;">{bullets}</ul>
</div>""", unsafe_allow_html=True)
