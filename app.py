    ...
    with form_col:
        ...
        if st.session_state.login_mode == "signin":
            ...
            if not is_configured():
                st.markdown(
                    '<div style="text-align:center;font-size:0.75rem;color:#52525b;'
                    'margin-top:0.75rem;padding:0.5rem;background:#18181b;border-radius:6px;border:1px solid #27272a;">'
                    'Demo: <span style="color:#a1a1aa;">TestUser</span> / '
                    '<span style="color:#a1a1aa;">User123</span>'
                    '</div>',
                    unsafe_allow_html=True,
                )
